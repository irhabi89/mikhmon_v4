                ...
                <div class="col-12">
                    <div class="card card-shadow">
                        <div class="card-header unselect">
                            ...
                            <span class="card-tab card-tab-active" id="btn-router-list"><i class="fa fa-th-list"></i> Router
                                List</span>
                            <?php if (isset($_GET['r']) && !empty($_GET['r'])) { ?>
                                <span class="card-tab card-tab-active" id="btn-edit-router"><i class="fa fa-tag"></i>
                                    <?= $_GET['r'] ?></span>
                                <script>
                        ...
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        foreach (file('./config/config.php', FILE_SKIP_EMPTY_LINES) as $line) {
                                            ...
                                            if ($s == "mikhmon") { ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="card-sq">
                                                            <div class="card-header-sq"><i class="fa fa-user-circle"></i> <b>Admin</b>
                                                                <span id="a-mess"></span>
                                                            </div>
                                                            <div class="card-body">
                                                                <table class="table">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2"><input id='userAdm' class="form-control "
                                                                                    type="text" value="<?= $useradm ?>"
                                                                                    autocomplete="off"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Password</td>
                                                                            <td style="max-width:100px">
                                                                                <input autocomplete="new-password" id="passAdm"
                                                                                    class="form-control  key" type="text"
                                                                                    value="<?= dec_rypt($passadm) ?>"
                                                                                    autocomplete="off">
                                                                            </td>
                                                                            <td width="5px">
                                                                                <div title="Show / hide password"
                                                                                    class="mr-t-5 text-center">
                                                                                    <input class="chkbox" onclick="shPass('passAdm')"
                                                                                        type="checkbox">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                ...
                                <div class="col-12" id="router-list">
                                    <div class="btn-group">
                                        <button class="bg-btn-group tooltip" id="btn-add-router"><i class="fa fa-plus"></i> Add
                                            Router
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="180px" class="text-center">
                                                                ...
                                                                <span title="Remove session <?= $s; ?>" class="btn" id="<?= $s; ?>r"
                                                                    onclick="removeRouter('<?= $s; ?>')">
                                                                    <i class="fa fa-trash text-danger"></i></span>
                                                                <span title="Edit session <?= $s; ?>" class="btn"
                                                                    onclick="editRouter('<?= $s; ?>')"><i class="fa fa-gear"></i></span>
                                                                <span title="Connect to session <?= $s; ?>" class="btn"
                                                                    onclick="connect('<?= $s; ?>p','<?= $s; ?>')" id="<?= $s; ?>">
                                                ...
                                                <div class="card-fixed">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="btn-group">
                                                                <button class="bg-btn-group"
                                                                    onclick="location.replace('./?admin/settings')"><i
                                                                        class="fa fa-close"></i> Close</button>
                                                                <button class="bg-btn-group" onclick="removeRouter('<?= $_GET['r']; ?>')"><i
                                                                        class="fa fa-trash"></i> Remove</button>
                                                                <button class="bg-btn-group" id="saveR"><i class="fa fa-save"></i>
                                                                    Save</button>
                                                                <button class="bg-btn-group" id="rConnect"><i class="fa fa-plug"></i>
                                                                    Connect </button>
                                                            </div>
                                                        </div>
                                                        <div class="col-6 mr-t-5">
                                                            <div class="col-12">
                                                                <div class="card-sq">
                                                                    <div id="ee-mess" class="card-header-sq"><i class="fa fa-server"></i>
                                                                        <b>Router</b> <span id="r-mess"></span>
                                                                    </div>
                                                                    <div class="card-body">
                                                                        ...
                                                                        <table class="table">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td colspan="2"><input id='sessName'
                                                                                            class="form-control" type="text"
                                                                                            value="<?= $_GET['r'] ?>" autocomplete="off">
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>IP MikroTik</td>
                                                                                    <td colspan="2"><input id="ipHost"
                                                                                            class="form-control asave" type="text"
                                                                                            value="<?= $iphost ?>" autocomplete="off"></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Username</td>
                                                                                    <td colspan="2"><input autocomplete="off" id="userHost"
                                                                                            class="form-control asave" type="text"
                                                                                            value="<?= $userhost ?>" autocomplete="off">
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Password</td>
                                                                                    <td style="max-width:100px">
                                                                                        <input autocomplete="new-password" id="passwdHost"
                                                                                            class="form-control asave key" type="text"
                                                                                            value="<?= dec_rypt($passwdhost) ?>"
                                                                                            autocomplete="off">
                                                                                    </td>
                                                                                    <td width="5px">
                                                                                        <div title="Show / hide password"
                                                            ...
                                                            <div class="col-12">
                                                                <div class="card-sq">
                                                                    <div class="card-header-sq"><i class="fa fa-server"></i> <b>Hotspot
                                                                            Info</b></div>
                                                                    <div class="card-body">
                                                                        <table class="table">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td><input id="hotspotNane" class="form-control asave"
                                                                                            type="text" value="<?= $hotspotname ?>"
                                                                                            autocomplete="off"></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>DNS Name</td>
                                                                                    <td><input id="dnsName" class="form-control asave"
                                                                                            type="text" value="<?= $dnsname ?>"
                                                                                            autocomplete="off"></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Currency</td>
                                                                                    <td><input id="currency" class="form-control asave"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <select id="idleTo"
                                                                                            class="form-control asave pointer">
                                                                                ...
                                                                                <tr>
                                                                                    <td>Phone</td>
                                                                                    <td><input id="phone" class="form-control asave"
                                                        ...
                                                        <div class="col-6 mr-t-5">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="card-sq">
                                                                        <div class="card-header-sq"><i class="fa fa-image"></i> <b>Upload
                                                                                Logo</b> <span id="r-mess"></span></div>
                                                                        <div class="card-body">
                                                                            <form action="" enctype="multipart/form-data" method="post"
                                                                                ...
                                                                                ?>
                                                                                <input class="hide" id="fileup" name="file" type="file"
                                                                                    accept="image/*" onchange="fileUpChk(this)"
                                                                                    required="1" />
                                                                                <div id="tempfileup">&nbsp;</div>
                                                                                <?= $upmess ?>
                                                                                <div class="btn mobile bg-btn-group" id="browsefile"><i
                                                                                        class="fa fa-search"></i> Browse File</div>
                                                                                <button class="btn bg-btn-group" name="submit"
                                                                                    type="submit"><i class="fa fa-upload"></i>
                                                                                    Upload</button>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="card-sq">
                                                                        <div class="card-header-sq"><i class="fa fa-info-circle"></i>
                                                                            <b>Help</b> <span id="r-mess"></span>
                                                                        </div>
                                                                        <div class="card-body">
                                                                            <table class="table table-bordered table-hover"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td>Session Name</td>
                                                                                        <td>Fill with one word without any special
                                                                                            characters.</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>DNS Name</td>
                                                                                        <td>Please check in Winbox, menu IP -> Hotspot ->
                                                                                            Server Profile.</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Idle Timeout</td>
                ...
                <div class="col-12" style="margin-bottom:100px;">
                    ...
                    <div class="mobile-card ">
                        ...
                        <div class="col-12 mr-b-10">
                            ...
                            <div class="col-10">
                                <h3><span id="pload"><i class="fa fa-th-list"></i> Route List</span></h3>
                            </div>
                            <div class="col-2">
                                <div class="dropdown">
                        ...
                        <div class="mr-t-10">
                            <div class="row">
                                ...
                                <div class="col-12 hide" id="mm-admin">
                                    <div class="btn-group">
                                        <button class="btn-mobile bg-btn-group" id="btn-asave"><i class="fa fa-save"></i>
                                            Save</button>
                                    </div>
                                    <div class="card-fixed mr-t-5">
                                                            ...
                                                            <div class="card-body">
                                                                <table class="table">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="min-width:100px">Username</td>
                                                                            <td colspan="2"><input id='userAdm' class="form-control adm"
                                                                                    type="text" value="<?= $useradm ?>"
                                                                                    autocomplete="off"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td style="max-width:100px">
                                                                                <input autocomplete="new-password" id="passAdm"
                                                                                    class="form-control adm key" type="text"
                                                                                    value="<?= dec_rypt($passadm) ?>"
                                                                                    autocomplete="off">
                                                                            </td>
                                                                            <td width="5px">
                                ...
                                <div class="col-12" id="router-list">
                                    <div class="btn-group">
                                        <button class="btn-mobile bg-btn-group tooltip" id="btn-add-router"><i
                                                class="fa fa-plus"></i> Add Router
                                                ...
                                                foreach (file('./config/config.php', FILE_SKIP_EMPTY_LINES) as $line) {
                                                    ...
                                                    if ($s == "" || $s == "mikhmon") {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="box-mobile"><i class="fa fa-wifi" id="<?= $s; ?>p"></i> <b>
                                                                        <?= $hn; ?></b><span style="float:right;">[<?= $i ?>]</span>
                                                                    <br>
                                                                    Session Name: <?= $s; ?><br>


                                                                    <span class="btn" id="<?= $s; ?>r"
                                                                        onclick="removeRouter('<?= $s; ?>')">
                                                                        <i class="fa fa-trash"></i> Remove
                                                                    </span>
                                                                    <span class="btn" onclick="editRouter('<?= $s; ?>')"><i
                                                                            class="fa fa-gear"></i> Edit</span>
                                                                    <span class="btn" onclick="connect('<?= $s; ?>p','<?= $s; ?>')"
                                                                        id="<?= $s; ?>">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="btn-group">
                                                                ...
                                                                <button class="btn-mobile bg-btn-group"
                                                                    onclick="removeRouter('<?= $_GET['r']; ?>')"><i class="fa fa-trash"></i>
                                                                    Remove</button>
                                                                <button class="btn-mobile bg-btn-group" id="saveR"><i
                                                                        class="fa fa-save"></i> Save</button>
                                                                <button class="btn-mobile bg-btn-group" id="rConnect"><i
                                                                        class="fa fa-plug"></i> Connect </button>
                                                            </div>
                                                        </div>
